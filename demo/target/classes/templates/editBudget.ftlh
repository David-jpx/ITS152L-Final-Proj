...
<head>
    ...
    <style>
        ...
        input { margin-top: 5px; padding: 6px; width: 250px; }
...
<body>
    ...
    <form action="/edit-budget/${budget.id}" method="post">
        ...
        <input type="text" name="department" id="department" value="${budget.department}" required>
        <label for="amount">Amount:</label>
        <input type="number" name="amount" id="amount" value="${budget.amount}" required>
        <br>
        <button type="submit">Update Budget</button>
    </form>
    <div style="margin-top: 20px;">
        <a href="http://localhost:18080/budgets" class="button-link">Back to Budgets</a>
